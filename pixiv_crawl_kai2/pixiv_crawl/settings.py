...
# COOKIES_DEBUG = True
IMAGES_STORE = 'crawlPixiv/'	#用于保存图片的地址，最后需要加上/

#########USER INFO
#在此处填写你的账号与密码
PIXIV_USER_NAME = 'xxx@xxxx.com'	#在此设置登录用户名
PIXIV_USER_PASS = 'xxxxxxxxxxxx'	#在此设置登录密码
#########HOST INFO
#在此处填写日期
START_DATE = datetime.date(2017,12,11)    #在此设置开始时间
#########PXIIV_MODE
__PIXIV_MODES__ = [
    'daily',        #0 每日热榜
    'weekly',       #1 每周热榜
